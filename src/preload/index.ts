...
contextBridge.exposeInMainWorld('api', {
  ...
  saveAccount: (account: unknown) => invoke('accounts:save', account),
  renameAccount: (id: string, name: string) => invoke('accounts:rename', id, name),
  ...
  reorderGroups: (ids: string[]) => invoke('groups:reorder', ids),
  ...
  connect: (accountId: string) => invoke('wa:connect', accountId),
  logout: (accountId: string) => invoke('wa:logout', accountId),
  waStatus: (accountId: string) => invoke('wa:status', accountId),
  waGroups: (accountId: string) => invoke('wa:groups', accountId),
  start: (accountId: string, ids: string[], message: string, lists: string[], mediaPaths?: string[], waGroups?: Array<{ id: string; name: string }>) => invoke('send:start', accountId, ids, message, lists, mediaPaths, waGroups),
